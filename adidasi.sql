...
('Nike x Off-White Air Force 1', 'Sneakers High Top dintr-o colaborare superba intre Nike si Off-White', 1299, 42, 'albastru', 'street', 'nike', '{"piele", "sintetice", "cauciuc"}', FALSE, '/resurse/imagini/galerie/sneaker1.jpg'),

('Nike x Off-White Air Force 1', 'Sneakers High Top dintr-o colaborare superba intre Nike si Off-White', 1299, 43, 'rosu', 'casual', 'nike', '{"piele", "sintetice", "cauciuc"}', False, '/resurse/imagini/galerie/sneaker2.jpg'),

('Nike X Off-White Air Jordan 4', 'Sneakers High Top dintr-o colaborare superba intre Nike si Off-White', 1499, 45, 'sail', 'casual', 'nike', '{"panza", "sintetice", "cauciuc", "silicon"}', True, '/resurse/imagini/galerie/sneaker3.jpg'),

('Nike Superrep', 'Adidasi de alergat comozi pentru o performanta crescuta', 499, 44, 'verde', 'running', 'nike', '{"panza", "sintetice", "cauciuc", "spuma"}', False, '/resurse/imagini/galerie/sneaker10.jpg'),
